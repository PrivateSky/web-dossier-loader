let APP_CONFIG = {
    THEME: "app",
    LABELS_DICTIONARY: {
        APP_NAME: "Cloud Safe Box",
        APP_DESCRIPTION: "A smart and safe application for your secrets",
        NEW_DOSSIER: "New CSB",
        RESTORE_DOSSIER: "Restore CSB",
        WALLET_AUTHORIZATION: "Wallet Authorization",
        PIN: "PIN",
        COMPLETE: "Complete",
        SET_UP_PIN: "Set up an easy to remember PIN",
